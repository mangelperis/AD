...
//		listStore.AppendValues (value);
		...
		listStoreArt = new ListStore (typeof(string), typeof(string), typeof(string), typeof(string));//typeof(decimal) -> precio
	...
	private void fillListStoreArt() {
		...
		while (dataReader.Read()) {
			...
			object precio = dataReader ["precio"].ToString();//QUITAR TO STRING para solucion 2
